  ...
  en: {
    ...
    onboarding: {
      ...
      categories: {
        ...
        local_favorites: 'Local Faves', shopping: 'Shopping', 
        walking_tours: 'Walking', family_friendly: 'Family',
        history: 'History', beaches: 'Beaches',
  ...
  es: {
    ...
    onboarding: {
      ...
      categories: {
        ...
        local_favorites: 'Locales', shopping: 'Compras', 
        walking_tours: 'A pie', family_friendly: 'Familiar', 
        history: 'Historia',  beaches: 'Playas',
  ...
  eu: {
    ...
    onboarding: {
      ...
      categories: {
        ...
        local_favorites: 'Bertakoak', shopping: 'Erosketak',
        walking_tours: 'Oinez', family_friendly: 'Familia', 
        history: 'Historia',  beaches: 'Hondartzak',
  ...
  fr: {
    ...
    onboarding: {
      ...
      categories: {
        ...
        local_favorites: 'Coups de cœur', shopping: 'Shopping', 
        walking_tours: 'À pied', family_friendly: 'Famille', 
        history: 'Histoire',  beaches: 'Plages',
